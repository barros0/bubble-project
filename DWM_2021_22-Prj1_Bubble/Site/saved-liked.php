...
$saved = $conn->query('select * from publicacoes_fav join publicacoes on publicacoes_fav.id_pub = publicacoes.publicacao_id where publicacoes_fav.id_user = ' . $userq['id_user']);
...
?>
    ...
    <div class="center">
        <div class="container-sl">
            <div>
                <div class="bns-change">
                    <button id="btc-l" class="l active">
                        Gostado
                    </button>
                    <button id="btc-s" class="s">
                        Guardado
                    </button>
            ...
            <script>
                $(document).ready(function() {
                    $("#btc-l").click(function() {
                        console.log(43)
                        $('#liked').addClass('active');
                        $('#saved').removeClass('active');
                        $('#btc-l').addClass('active');
                        $('#btc-s').removeClass('active');
                    })

                    $("#btc-s").click(function() {
                        $('#liked').removeClass('active');
                        $('#saved').addClass('active');
                        $('#btc-l').removeClass('active');
                        $('#btc-s').addClass('active');
                    })
                })
            </script>
        ...
        <style>
            ...
            .bns-change button.active {
                background-color: var(--verde);
            }

            .bns-change button:hover {
