...
$list_seguidores = $conn->query('select * from seguir where id_seguidor = ' . $user_perfil_id);
...
<div class="home">
    ...
    <div class="amigos">
        <div class="followers">
            ...
            <a class="right_followers active_right" href="conexoes_aseguir.php">
        ...
        <div class="listagem_users">
            ...
            foreach ($list_seguidores as $list_seguidor) {
                ...
                $user = $conn->query("select * from users where id_user=" . $user_aseguir)->fetch_assoc();
            ?>
