...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Maio-2022 às 17:50
...
INSERT INTO `comentarios` (`comentario_id`, `user_id`, `comentario`, `resposta_id`, `estado`, `created_at`, `updated_at`, `publicacao_id`) VALUES
(1, 1, 'teste ahahah xD', NULL, 1, '2022-05-20 10:29:12', '2022-05-20 11:29:12', 1);
...
(1, 1, 1, 'teste mensagem texto', 1, '2022-05-20 10:36:23', '2022-05-20 11:36:23');
...
(2, 1, 2, '2022-05-19 10:39:35', '2022-05-20 11:28:19'),
(3, 1, 3, '2022-05-20 08:28:26', '2022-05-20 11:30:36');
...
--
-- Extraindo dados da tabela `notificacoes_comentario`
--

INSERT INTO `notificacoes_comentario` (`notificacao_comentario_id`, `id_notificacao`, `id_comentario`, `created_at`, `updated_at`) VALUES
(1, 2, 1, '2022-05-20 10:28:45', '2022-05-20 11:28:45');
...
--
-- Extraindo dados da tabela `notificacoes_mensagem`
--

INSERT INTO `notificacoes_mensagem` (`notificacao_mensagem_id`, `id_notificacao`, `id_mensagem`, `created_at`, `updated_at`) VALUES
(1, 3, 1, '2022-05-20 10:35:51', '2022-05-20 11:35:51');
...
(2, 1, 'teste 2', 1, '2022-05-26 08:40:28', '2022-05-26 09:40:28'),
(3, 1, 'teste 3', 1, '2022-05-26 08:40:28', '2022-05-26 09:40:28');
...
INSERT INTO `users` (`id_user`, `nome`, `username`, `email`, `password`, `banner_image`, `profile_image`, `nacionalidade`, `tipo`, `estado`, `genero`, `created_at`, `updated_at`, `data_nascimento`) VALUES
(1, 'Lopes da Silva', 'Xo_Guarda', 'porcoassassino1@gmail.com', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', NULL, 'lopess.png', NULL, 1, 2, 1, '2022-05-18 08:10:23', '2022-05-25 11:30:52', '2003-05-01'),
(2, 'Pedro oliveira', 'pedro_oliveira', 'pedro@oliveira.com', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', NULL, NULL, 2, 2, 2, 1, '2022-05-26 08:57:49', '2022-05-26 09:57:49', '2001-05-08'),
(3, 'joao', 'j_joao', 'teste2@gamil.come', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', NULL, NULL, 5, 2, 1, 2, '2022-05-26 13:44:40', '2022-05-26 14:44:40', '2000-05-18'),
(4, 'joana pereira', 'joana21', 'sdsda@gmail.com', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', NULL, NULL, 4, 2, 1, 3, '2022-05-26 13:47:46', '2022-05-26 14:47:46', '2000-05-18');
...
--
ALTER TABLE `notificacoes_mensagem`
  MODIFY `notificacao_mensagem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `publicacoes`
  MODIFY `publicacao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
