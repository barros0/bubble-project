...
-- -----------------------------------------------------
-- Table `Bubble`.`Amizades`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bubble`.`Amizades` (
...
CREATE TABLE IF NOT EXISTS `Bubble`.`guardado` (
  ...
  INDEX `fk_guardado_Utilizador1_idx` (`Utilizador_IDUtilizador` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `Bubble`.`DefinicoesUser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bubble`.`DefinicoesUser` (
  `DarkMode` INT NULL,
  `Utilizador_IDUtilizador` INT NOT NULL,
